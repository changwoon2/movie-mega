...
(function (b) {
  b.fn.bPopup = function (z, F) {
        ...
        default:
          A(),
            b('<div class="b-ajax-wrapper"></div>')
              .load(a.loadUrl, a.loadData, function (c, d, e) {
                k(a.loadCallback, d);
                G(b(this));
              })
              .hide()
    ...
    function q() {
      ...
      h.unbind("." + e).data(
        "bPopup",
        0 < h.data("bPopup") - 1 ? h.data("bPopup") - 1 : null
      );
      ...
      switch (d ? a.transition : a.transitionClose || a.transition) {
        case "slideIn":
          b({
            left: d
              ? l(!((!a.follow[0] && m) || g))
              : f.scrollLeft() - (s || c.outerWidth(!0)) - C,
          });
          break;
        case "slideBack":
          b({
        ...
        case "slideDown":
          b({
            top: d
              ? n(!((!a.follow[1] && p) || g))
              : f.scrollTop() - (r || c.outerHeight(!0)) - C,
          });
          break;
        case "slideUp":
          b({
    ...
    function L(b) {
      b
        ? (N(), k(F), a.autoClose && (I = setTimeout(q, a.autoClose)))
        : (c.hide(),
          k(a.onClose),
          a.loadUrl &&
